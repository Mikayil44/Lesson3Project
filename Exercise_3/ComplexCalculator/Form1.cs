    ...
    public partial class Form1 : Form
    {
        ...
        private void sqrt_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (result < 0)
                {
                    MessageBox.Show("Mənfi ədədin kvadrat kökü alınmır!", "Error");
                    return;
                }
            ...
            {
                MessageBox.Show("Düzgün ədəd daxil edin.", "Error");
            }
            catch (Exception ex)
            {
                MessageBox.Show("Xəta baş verdi: " + ex.Message, "Error");
            }
        }
        ...
        private void equals_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("0-a bölmək mümkün deyil!", "Error");
                    return;
                }
            ...
            {
                MessageBox.Show("Daxil edilmiş ifadə düzgün deyil.", "Error");
            }
            catch (Exception ex)
            {
                MessageBox.Show("Xəta baş verdi: " + ex.Message, "Error");
